...
//This plugin allows refreshing of AJAX data with the call .fnReloadAjax();
$.fn.dataTableExt.oApi.fnReloadAjax=function(a,b,d,f){"undefined"!=typeof b&&null!=b&&(a.sAjaxSource=b);if(a.oFeatures.bServerSide)this.fnDraw();else{this.oApi._fnProcessingDisplay(a,!0);var c=this,g=a._iDisplayStart;b=[];this.oApi._fnServerParams(a,b);a.fnServerData.call(a.oInstance,a.sAjaxSource,b,function(b){c.oApi._fnClearTable(a);b=""!==a.sAjaxDataProp?c.oApi._fnGetObjectDataFn(a.sAjaxDataProp)(b):b;for(var e=0;e<b.length;e++)c.oApi._fnAddData(a,b[e]);a.aiDisplay=a.aiDisplayMaster.slice();"undefined"!=
typeof f&&!0===f?(a._iDisplayStart=g,c.fnDraw(!1)):c.fnDraw();c.oApi._fnProcessingDisplay(a,!1);"function"==typeof d&&null!=d&&d(a)},a)}};
